...
class OpenAIAzureSDKClient:
    """Azure OpenAI LLM client that relies on the official Python SDK."""
    ...
    async def summarize(
        ...
        *,
        ...
        logger.debug("Azure OpenAI summarize response: %s", response)
        return content or ""
    ...
    async def vision(
        ...
        *,
        ...
        """
        Call Azure OpenAI Vision API with an image.
        ...
        content = response.choices[0].message.content
        logger.debug("Azure OpenAI vision response: %s", response)
        return content or ""
    ...
    async def transcribe(
        ...
        *,
        ...
        """
        Transcribe audio file using Azure OpenAI Audio API.
        ...
        try:
            ...
            logger.debug("Azure OpenAI transcribe response for %s: %s chars", audio_path, len(result))
        except Exception:
